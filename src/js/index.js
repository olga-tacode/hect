...
const sectionLinksContainer = document.querySelectorAll(
...
function hamburgerIconColor() {
  let iconDisplayStyle = window
    .getComputedStyle(homeSection, null)
...
contactLink.addEventListener("click", hideContact);

const contactLogo = () => {
  socialList.classList.remove("hide");
};
logo.addEventListener("click", contactLogo);

const contactAbout = () => {
  socialList.classList.remove("hide");
};
aboutLink.addEventListener("click", contactAbout);

const contactFilm = () => {
  socialList.classList.remove("hide");
};
filmLink.addEventListener("click", contactFilm);
